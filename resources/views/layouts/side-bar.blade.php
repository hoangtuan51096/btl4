...
<div class="list-group" id="list-tab" role="tablist">
    <a href="{{ route('author.index') }}" class="list-group-item list-group-item-action" id="list-home-list">Sach</a>
    ...
    <a href="{{ route('user.index') }}" class="list-group-item list-group-item-action" id="list-messages-list">Thung rac</a>
</div>